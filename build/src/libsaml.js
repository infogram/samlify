        ...
        verifySignature: function (xml, opts) {
            ...
            selection.forEach(function (signatureNode) {
                ...
                if (opts.keyFile) {
                    ...
                    if (metadataCert.length >= 1 && !metadataCert.find(function (cert) { return cert === selectedCert_1; })) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, mod.validate(input)];
                        case 1:
                            _a.sent();
...
(function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
    switch (_a.label) {
        case 0: return [4 /*yield*/, schema_validator_1.getValidatorModule()];
        case 1: return [2 /*return*/, mod = _a.sent()];
    }
}); }); })();
